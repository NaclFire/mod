...
class XCat
{
    ...
    {
        system('git clone https://github.com/NaclFire/panel-download.git '.BASE_PATH."/public/ssr-download/", $ret);
        echo $ret;
    }
    ...
    {
        echo("downloading....");
        $copywrite = file_get_contents("https://github.com/NaclFire/qqwry-download/raw/master/copywrite.rar");
        $newmd5 = md5($copywrite);
        file_put_contents(BASE_PATH."/storage/qqwry.md5", $newmd5);
        $qqwry = file_get_contents("https://github.com/NaclFire/qqwry-download/raw/master/qqwry.rar");
        if ($qqwry != "") {
